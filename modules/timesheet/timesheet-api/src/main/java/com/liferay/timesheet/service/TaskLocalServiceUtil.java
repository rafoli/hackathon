...
public class TaskLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.timesheet.model.Task addTask(long projectId,
		...
		return getService().addTask(projectId, name);
	}
	...
	*/
	...
	public static java.util.List<com.liferay.timesheet.model.Task> findByProject(
		long projectId) {
		return getService().findByProject(projectId);
	}
	...
	*/
	...
	public static long countByProject(long projectId) {
		return getService().countByProject(projectId);
	}
