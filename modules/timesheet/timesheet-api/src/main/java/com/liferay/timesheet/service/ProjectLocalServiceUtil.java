...
public class ProjectLocalServiceUtil {
	...
	*/
	...
	public static com.liferay.timesheet.model.Project addProject(
		long clientId, java.lang.String name, java.util.Date starts,
		java.util.Date ends) {
		return getService().addProject(clientId, name, starts, ends);
	}
	...
	*/
	...
	public static java.util.List<com.liferay.timesheet.model.Project> findByClient(
		long clientId) {
		return getService().findByClient(clientId);
	}
	...
	*/
	...
	public static long countByClient(long clientId) {
		return getService().countByClient(clientId);
	}
