...
/**
 * Provides the local service interface for TimeEntry. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TimeEntryLocalServiceUtil
...
public interface TimeEntryLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TimeEntryLocalServiceUtil} to access the time entry local service. Add custom service methods to {@link com.liferay.timesheet.service.impl.TimeEntryLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public TimeEntry addTimeEntry(long userId, java.lang.Double hours,
		long projectId, long taskId, boolean billable, long timesheetId,
		Date forDate, java.lang.String message);
	...
	*/
	...
	public List<TimeEntry> findByUser(long userId);

	public List<TimeEntry> findByUserDate(long userId, Date onDate);
	...
	*/
	...
	public long countByUserDate(long userId, Date onDate);
