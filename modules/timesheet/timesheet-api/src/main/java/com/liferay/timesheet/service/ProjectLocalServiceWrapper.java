...
public class ProjectLocalServiceWrapper implements ProjectLocalService,
	...
	*/
	...
	@Override
	public com.liferay.timesheet.model.Project addProject(long clientId,
		java.lang.String name, java.util.Date starts, java.util.Date ends) {
		return _projectLocalService.addProject(clientId, name, starts, ends);
	}
	...
	*/
	...
	@Override
	public java.util.List<com.liferay.timesheet.model.Project> findByClient(
		long clientId) {
		return _projectLocalService.findByClient(clientId);
	}
	...
	*/
	...
	public long countByClient(long clientId) {
		return _projectLocalService.countByClient(clientId);
	}
