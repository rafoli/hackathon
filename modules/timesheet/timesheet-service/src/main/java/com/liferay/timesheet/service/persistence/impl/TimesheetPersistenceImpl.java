...
import com.liferay.timesheet.model.impl.TimesheetImpl;
import com.liferay.timesheet.model.impl.TimesheetModelImpl;
 ...
 * @see com.liferay.timesheet.service.persistence.TimesheetUtil
 * @generated
 */
@ProviderType
public class TimesheetPersistenceImpl extends BasePersistenceImpl<Timesheet>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_USERIDOPEN =
		new FinderPath(TimesheetModelImpl.ENTITY_CACHE_ENABLED,
			TimesheetModelImpl.FINDER_CACHE_ENABLED, TimesheetImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByUserIdOpen",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERIDOPEN =
		new FinderPath(TimesheetModelImpl.ENTITY_CACHE_ENABLED,
			TimesheetModelImpl.FINDER_CACHE_ENABLED, TimesheetImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByUserIdOpen",
			new String[] { Long.class.getName(), Boolean.class.getName() },
			TimesheetModelImpl.USERID_COLUMN_BITMASK |
			TimesheetModelImpl.OPEN_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_USERIDOPEN = new FinderPath(TimesheetModelImpl.ENTITY_CACHE_ENABLED,
			TimesheetModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByUserIdOpen",
			new String[] { Long.class.getName(), Boolean.class.getName() });
	 ...
	 */
	@Override
	public List<Timesheet> findByUserIdOpen(long userId, boolean open) {
		return findByUserIdOpen(userId, open, QueryUtil.ALL_POS,
			QueryUtil.ALL_POS, null);
	}
	...
	public List<Timesheet> findByUserIdOpen(long userId, boolean open,
		int start, int end) {
		return findByUserIdOpen(userId, open, start, end, null);
	}
	...
	public List<Timesheet> findByUserIdOpen(long userId, boolean open,
		...
		return findByUserIdOpen(userId, open, start, end, orderByComparator,
			true);
	}
	...
	public List<Timesheet> findByUserIdOpen(long userId, boolean open,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
				(orderByComparator == null)) {
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERIDOPEN;
			finderArgs = new Object[] { userId, open };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_USERIDOPEN;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_USERIDOPEN_USERID_2);

			query.append(_FINDER_COLUMN_USERIDOPEN_OPEN_2);
	...
	public Timesheet findByUserIdOpen_First(long userId, boolean open,
		OrderByComparator<Timesheet> orderByComparator)
		throws NoSuchTimesheetException {
		Timesheet timesheet = fetchByUserIdOpen_First(userId, open,
				orderByComparator);
	...
	public Timesheet fetchByUserIdOpen_First(long userId, boolean open,
		OrderByComparator<Timesheet> orderByComparator) {
		List<Timesheet> list = findByUserIdOpen(userId, open, 0, 1,
				orderByComparator);
	...
	public Timesheet findByUserIdOpen_Last(long userId, boolean open,
		OrderByComparator<Timesheet> orderByComparator)
		throws NoSuchTimesheetException {
		Timesheet timesheet = fetchByUserIdOpen_Last(userId, open,
				orderByComparator);
	...
	public Timesheet fetchByUserIdOpen_Last(long userId, boolean open,
		OrderByComparator<Timesheet> orderByComparator) {
		int count = countByUserIdOpen(userId, open);

		if (count == 0) {
			return null;
		}

		List<Timesheet> list = findByUserIdOpen(userId, open, count - 1, count,
				orderByComparator);
	...
	public Timesheet[] findByUserIdOpen_PrevAndNext(long timesheetId,
		...
		try {
			...
			array[0] = getByUserIdOpen_PrevAndNext(session, timesheet, userId,
					open, orderByComparator, true);

			array[1] = timesheet;

			array[2] = getByUserIdOpen_PrevAndNext(session, timesheet, userId,
					open, orderByComparator, false);
	...
	protected Timesheet getByUserIdOpen_PrevAndNext(Session session,
		Timesheet timesheet, long userId, boolean open,
		OrderByComparator<Timesheet> orderByComparator, boolean previous) {
		StringBundler query = null;
	...
	public void removeByUserIdOpen(long userId, boolean open) {
		for (Timesheet timesheet : findByUserIdOpen(userId, open,
	...
	public int countByUserIdOpen(long userId, boolean open) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_USERIDOPEN;

		Object[] finderArgs = new Object[] { userId, open };
	...
	private static final String _FINDER_COLUMN_USERIDOPEN_USERID_2 = "timesheet.userId = ? AND ";
	private static final String _FINDER_COLUMN_USERIDOPEN_OPEN_2 = "timesheet.open = ?";
	...
	public Timesheet updateImpl(Timesheet timesheet) {
		...
		if (isNew || !TimesheetModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((timesheetModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERIDOPEN.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						timesheetModelImpl.getOriginalUserId(),
						timesheetModelImpl.getOriginalOpen()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_USERIDOPEN, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_USERIDOPEN,
					args);

				args = new Object[] {
						timesheetModelImpl.getUserId(),
						timesheetModelImpl.getOpen()
					};
	...
	protected Timesheet toUnwrappedModel(Timesheet timesheet) {
		...
		timesheetImpl.setDateFrom(timesheet.getDateFrom());
		timesheetImpl.setUserId(timesheet.getUserId());
		timesheetImpl.setDateTo(timesheet.getDateTo());
		timesheetImpl.setApproved(timesheet.isApproved());
		timesheetImpl.setOpen(timesheet.isOpen());
		timesheetImpl.setSubmittedOn(timesheet.getSubmittedOn());
		timesheetImpl.setApprovedOn(timesheet.getApprovedOn());
