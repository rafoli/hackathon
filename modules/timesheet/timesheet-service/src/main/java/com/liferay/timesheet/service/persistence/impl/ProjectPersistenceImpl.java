 ...
 * @see com.liferay.timesheet.service.persistence.ProjectUtil
 * @generated
 */
@ProviderType
public class ProjectPersistenceImpl extends BasePersistenceImpl<Project>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_CLIENT = new FinderPath(ProjectModelImpl.ENTITY_CACHE_ENABLED,
			ProjectModelImpl.FINDER_CACHE_ENABLED, ProjectImpl.class,
			FINDER_CLASS_NAME_LIST_WITH_PAGINATION, "findByClient",
			new String[] {
				Long.class.getName(),
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CLIENT =
		new FinderPath(ProjectModelImpl.ENTITY_CACHE_ENABLED,
			ProjectModelImpl.FINDER_CACHE_ENABLED, ProjectImpl.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByClient",
			new String[] { Long.class.getName() },
			ProjectModelImpl.CLIENTID_COLUMN_BITMASK |
			ProjectModelImpl.NAME_COLUMN_BITMASK);
	public static final FinderPath FINDER_PATH_COUNT_BY_CLIENT = new FinderPath(ProjectModelImpl.ENTITY_CACHE_ENABLED,
			ProjectModelImpl.FINDER_CACHE_ENABLED, Long.class,
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "countByClient",
			new String[] { Long.class.getName() });
	...
	public List<Project> findByClient(long clientId) {
		return findByClient(clientId, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Project> findByClient(long clientId, int start, int end) {
		return findByClient(clientId, start, end, null);
	}
	...
	public List<Project> findByClient(long clientId, int start, int end,
		...
		return findByClient(clientId, start, end, orderByComparator, true);
	}
	...
	public List<Project> findByClient(long clientId, int start, int end,
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			pagination = false;
			finderPath = FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CLIENT;
			finderArgs = new Object[] { clientId };
		}
		else {
			finderPath = FINDER_PATH_WITH_PAGINATION_FIND_BY_CLIENT;
		...
		if (list == null) {
			...
			query.append(_FINDER_COLUMN_CLIENT_CLIENTID_2);
	...
	public Project findByClient_First(long clientId,
		...
		Project project = fetchByClient_First(clientId, orderByComparator);
	...
	public Project fetchByClient_First(long clientId,
		OrderByComparator<Project> orderByComparator) {
		List<Project> list = findByClient(clientId, 0, 1, orderByComparator);
	...
	public Project findByClient_Last(long clientId,
		OrderByComparator<Project> orderByComparator)
		throws NoSuchProjectException {
		Project project = fetchByClient_Last(clientId, orderByComparator);
	...
	public Project fetchByClient_Last(long clientId,
		OrderByComparator<Project> orderByComparator) {
		int count = countByClient(clientId);

		if (count == 0) {
			return null;
		}

		List<Project> list = findByClient(clientId, count - 1, count,
				orderByComparator);
	...
	public Project[] findByClient_PrevAndNext(long projectId, long clientId,
		...
		try {
			...
			array[0] = getByClient_PrevAndNext(session, project, clientId,
					orderByComparator, true);

			array[1] = project;

			array[2] = getByClient_PrevAndNext(session, project, clientId,
	...
	protected Project getByClient_PrevAndNext(Session session, Project project,
		long clientId, OrderByComparator<Project> orderByComparator,
		boolean previous) {
		StringBundler query = null;
	...
	public void removeByClient(long clientId) {
		for (Project project : findByClient(clientId, QueryUtil.ALL_POS,
	...
	public int countByClient(long clientId) {
		FinderPath finderPath = FINDER_PATH_COUNT_BY_CLIENT;
	...
	private static final String _FINDER_COLUMN_CLIENT_CLIENTID_2 = "project.clientId = ?";
	...
	public Project updateImpl(Project project) {
		...
		if (isNew || !ProjectModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((projectModelImpl.getColumnBitmask() &
					FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CLIENT.getColumnBitmask()) != 0) {
				Object[] args = new Object[] {
						projectModelImpl.getOriginalClientId()
					};

				finderCache.removeResult(FINDER_PATH_COUNT_BY_CLIENT, args);
				finderCache.removeResult(FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_CLIENT,
					args);
	...
	protected Project toUnwrappedModel(Project project) {
		...
		projectImpl.setStartsOn(project.getStartsOn());
		projectImpl.setEndsOn(project.getEndsOn());
